      ...
      <form onSubmit={handlePasscodeSubmit} className="flex flex-col gap-4">
        ...
        {!isAdmin && (
          <button
            ...
            className="self-center text-soft/60 hover:text-soft text-xs font-sans transition-colors flex items-center gap-1"
          >
  ...
  return (
    <div className="relative min-h-dvh flex items-center justify-center bg-balete-deep overflow-hidden grain">
      <button
        ...
        className="absolute top-4 right-4 z-10 p-2.5 rounded-xl text-soft hover:text-parchment hover:bg-rattan/15 transition-all duration-200"
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.24-.438.613-.43.992a7.593 7.593 0 0 1 0 .255c-.008.378.137.75.43.99l1.005.828c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.992a7.593 7.593 0 0 1 0-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z" />
      ...
      <div className="relative w-full max-w-sm mx-4 animate-fade-in">
        ...
        <div className="card rounded-2xl p-6 animate-slide-up" style={{ animationDelay: "0.15s" }}>
          <Suspense fallback={
            ...
            <GateForm adminMode={adminMode} onAdminMode={setAdminMode} />
          </Suspense>
        </div>
      </div>
    </div>
